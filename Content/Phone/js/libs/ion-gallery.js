(function () {
  ...
  ionGallery.$inject = ['$ionicPlatform', 'ionGalleryHelper', 'ionGalleryConfig', '$timeout'];

  function ionGallery($ionicPlatform, ionGalleryHelper, ionGalleryConfig, $timeout) {
